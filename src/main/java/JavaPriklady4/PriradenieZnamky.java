...
public class PriradenieZnamky {
    ...
    public static String hodnot ( int percenta){
        ...
        if (percenta > 90)
           ...
           znamka = "Neočakávaná vstupná hodnota";
        return znamka;
...
*/
// TODO Vytvorit "nekonecny" pouzivatelsky vstup na zadavanie a vyhodnotenie znamok. Ukonci, pokym nezadame zaporne cislo.
//  Pouzite prikazu while = cyklus s podmienkou na zaciatku.
