...
// the mysql insert statement
        String query = "INSERT INTO kniha (nazov) VALUES (?)";
    ...
    public static void aktualizuj(Connection conn) throws SQLException {
        ...
        String query = "UPDATE kniha SET nazov = ? WHERE id = ?";
        PreparedStatement preparedStmt = conn.prepareStatement(query);
    ...
    public static void main(String[] args) {
        ...
        System.out.println("SELECT all data FROM kniha");
        try {
            vyber(conn);
        } catch (SQLException e) {
        ...
        System.out.println("UPDATE kniha WITH id = 1");
        try {
            aktualizuj(conn);
        } catch (SQLException e) {
            throw new RuntimeException(e);
        ...
        System.out.println("INSERT new kniha");
        try {
            vloz(conn);
        } catch (SQLException e) {
            throw new RuntimeException(e);
        ...
        System.out.println("DELETE kniha WITH id = 1");
        try {
            odstran(conn);
        } catch (SQLException e) {
            throw new RuntimeException(e);
